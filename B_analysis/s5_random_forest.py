...
def train_rf(df, fold_col_nm, target_ls, metrics_ls, n_samp_train="all"):
    ...
    if n_samp_train == "all":
        ...
        train_df = df[df[fold_col_nm] == "train"].sample(n=n_samp_train)
...
n_train_ls = list(range(10, 180, 10))
...
for n_train in tqdm(n_train_ls, 
    ...
    for i in tqdm(range(1, 6), 
            ...
            for _ in tqdm(range(5), 
                ...
                metrics_df_i, obs_pred_df_i = train_rf(df, "strat_fold_" + str(1), target_ls, metrics_ls, n_train)
                
                metrics_df_i['cv_fold_num'] = i
                obs_pred_df_i['cv_fold_num'] = i
